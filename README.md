...
This repository contains the source code for the [HTTP Tester](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.wemakestuff.httptester).

Please see the [issues](https://github.com.wemakestuff.httptester/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about HTTP Tester? Ask away on the [com-wemakestuff-httptester discussion forum](https://groups.google.com/forum/#!forum/com-wemakestuff-httptester). 

<a href="https://play.google.com/store/apps/details?id=com.wemakestuff.httptester" alt="Download from Google Play">
...
After generating the app on [AndroidBootstrap.com](http://www.androidbootstrap.com) the folder structure of the source code for the app will change:
  ...
  - From: __com.wemakestuff.httptester__ 
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.wemakestuff.httptester__ will be moved to the new folder __com/notify/app/mobile__. 

All import statments that reference the old resources (__R.com.wemakestuff.httptester.R__) will now be renamed to the correct package. The artifact id's in the *pom.xml* (and various other places) will be replaced. The App Name will be replaced in the strings/etc. 
...
signed with a different key.  Manually uninstall HTTP Tester from your device and
you will then be able to install your own built version.

## Acknowledgements

HTTP Tester is a result of a template project I've developed over the years as well as
...
HTTP Tester is built on the awesome [Parse.com API](http://www.parse.com/)
...
[pull requests](https://github.com.wemakestuff.httptester/pulls).
